...
<header id="navbar-spy" class="header header-1 header-transparent header-fixed">
            <nav id="primary-menu" class="navbar navbar-fixed-top">
                ...
                <span class="icon-bar"></span>
                 ...
                 <a class="logo" href="index.php"</a> <img src="assets/images/logo/ally.jpg" height="50"></a>                    
                </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse pull-right" id="navbar-collapse-1">
                        ...
                        <div class="module module-login pull-left">
                            <?php if (strlen($_SESSION['remsuid']==0)) {?>  
                            <a class="btn-popup" data-toggle="modal" data-target="#signupModule">Login/Sign Up</a>
                            <?php } ?>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane fade in active" id="login">
                                                        <div class="signup-form-container text-center">
                                                            <form class="mb-0" method="post" name="signin">
                                                                ...
                                                                <div class="or-text">
                                                                <span style="color: blue">ALLY</span>
                                                            </div>
                                                    ...
                                                    <div class="tab-pane" id="signup">
                                                        <form class="mb-0" method="post" name="signup">
                                                            ...
                                                            <div class="or-text">
                                                                <span style="color: blue">MASKANI</span>
                                                            </div>
                                                            <div class="form-group">
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                             ...
                                                             <div class="form-group">
                                                                ...
                                                                <input type="radio" name="usertype" value="1" checked="true">Agent &nbsp; &nbsp;<input type="radio" name="usertype" value="2" >Landlord &nbsp; &nbsp; <input type="radio" name="usertype" value="3">User
                                                            </div>
                                                            <!-- .form-group end -->
