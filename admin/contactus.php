...
?>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Mobile Number (begin with 254...)</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                               <input type="text" name="mobnum" id="mobnum" value="<?php  echo $row['MobileNumber'];?>" class="form-control" required='true' maxlength="12" pattern='[0-9]+'>
                                            </div>
                                        </div>
                                        <div class="form-group row">
