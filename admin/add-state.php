...
$cmsaid=$_SESSION['remsaid'];
 ...
 $query=mysqli_query($con,"insert into tblstate(CountryID,StateName) value('$countryid','$statename')");
    ...
    if ($query) {
    echo '<script>alert("Region has been added.")</script>';
...
<head>
    ...
    <title>maskani-Admin || Add Region</title>
    <!-- Bootstrap CSS -->
    ...
    echo $msg;
              ...
              ?>      
                  ...
                  <?php } ?>
                                         ...
                                         <div class="form-group row">
                                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Reion Name</label>
                                            <div class="col-12 col-sm-8 col-lg-6">
                                                <input type="text" name="statename" id="statename" required="true" placeholder="Region Name" class="form-control">
                                            </div>
                                        </div>
