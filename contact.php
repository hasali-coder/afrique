...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Maskani || Contact Page</title>
</head>
...
?>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-md-offset-1 bg-white p-30 bg-white">
                        ...
                        <div class="about--img"><img class="img-responsive" src="assets/images/about/download.jpg" width="750" height="200" alt="about img"></div>
                    </div>
                    <!-- .col-md-8 end -->
                </div>
               <?php } ?>
