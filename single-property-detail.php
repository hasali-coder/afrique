...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Maskani || Single Property Detail</title>
</head>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <ul class="list-unstyled mb-20">
                                        ...
                                        <li><span>County:</span><?php echo $row['CountryName'];?></li>
                            ...
                            <div class="widget--content">
                                ...
                                <div class="agent--contact">
                                    <ul class="list-unstyled">
                                        <a href="tel:<?php echo $row1['MobileNumber'];?>"><li><i class="fa fa-phone"></i><?php echo $row1['MobileNumber'];?></li></a>
                                        <li><i class="fa fa-envelope-o"></i><?php echo $row1['Email'];?></li>
                                        <li><i class="fa fa-whatsapp"></i><?php echo $row1['MobileNumber'];?></li>
...
<!-- widget mortgage calculator=============================-->
                        ...
                        <div class="widget widget-mortgage-calculator">
                            <div class="widget--title">
                                <h5>Mortage Calculator</h5><i>for use of property is stated for sale</i>
                            </div>
                            <div class="widget--content">
     <form class="mb-0" method="post" action="calculator.php">
                                    <div class="form-group">
                                        <label for="sale-price">Sale Price</label>
                                        <input type="text" class="form-control" name="saleprice" id="saleprice" placeholder="Ksh" required="true">
                                    </div>
                                    <!-- .form-group end -->
                                    <div class="form-group">
                                        <label for="down-payment">Down Payment/Principal</label>
                                        <input type="text" class="form-control" name="downpayment" id="downpayment" placeholder="Ksh" required="true">
                                    </div>
                                    <!-- .form-group end -->
                                    <div class="form-group">
